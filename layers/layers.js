...
lyr_SriLankaDistricts_1.set('fieldLabels', {'shapeName': 'inline label - always visible', 'shapeISO': 'inline label - always visible', 'shapeID': 'no label', 'shapeGroup': 'no label', 'shapeType': 'no label', });
lyr_SriLankaRoads_2.set('fieldLabels', {'name': 'inline label - always visible', 'name_en': 'inline label - always visible', 'highway': 'no label', 'surface': 'no label', 'smoothness': 'no label', 'width': 'no label', 'lanes': 'no label', 'oneway': 'no label', 'bridge': 'no label', 'layer': 'no label', 'source': 'no label', 'name_si': 'no label', 'name_ta': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', });
lyr_SriLankaWaterways_3.set('fieldLabels', {'name': 'inline label - always visible', 'name_en': 'inline label - always visible', 'waterway': 'no label', 'covered': 'no label', 'width': 'no label', 'depth': 'no label', 'layer': 'no label', 'blockage': 'no label', 'tunnel': 'no label', 'natural': 'no label', 'water': 'no label', 'source': 'no label', 'name_si': 'no label', 'name_ta': 'no label', 'osm_id': 'no label', 'osm_type': 'no label', });
